        ...
        <div className=' bg-white w-[100%] h-[71px] top-0  shadow fixed z-10 '>
            <div className=' max-w-[1200px] mx-auto'>
               <div className=' flex  justify-between'>
                 ...
                 <div className=' mt-5 lg:mr-0 md:mr-12 sm:mr-5 flex relative'>
                    ...
                    <div className=' bg-red-600 fixed -mt-2.5 ml-4 w-7 h-7 rounded-full flex justify-center items-center font-medium text-white'>
                      <h1>{totalItems}</h1>
                    </div>
                 </div>
               </div>
